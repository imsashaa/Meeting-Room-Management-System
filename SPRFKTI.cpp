...
int tanggal=1,bulan=1,tahun=2018, dur=0, pkt=1;
int count = 0;
...
int g_detailRuang(int pildata, int y){
	if(y<32){
		if(pildata==1){
			y = 7;
...
void g_peminjaman(string ruangp, string waktup, string harip){
	peminjaman z;
    ...
    do{
	    ...
	    case '2' :
	    	do{
				...
				table(1);
				while(x2!=13){
					g_detailRuang(pildata, y);x2=getch();
					if(x2==72){
	...
	switch(pilhari){
		case 1: table(4);
				...
				if(cekpeminjaman("Senin",point->namar,"Malam")){
					g_peminjaman(point->namar,"Malam","Senin");	
				}else{
		...
		case 2: table(4);
				...
				if(cekpeminjaman("Selasa",point->namar,"Malam")){
					g_peminjaman(point->namar,"Malam","Selasa");	
				}else{
					gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
					goto ulang;
				}
		...
		case 3: table(4);
				...
				if(cekpeminjaman("Rabu",point->namar,"Malam")){
					g_peminjaman(point->namar,"Malam","Rabu");	
				}else{
					gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
					goto ulang;
				}
		...
		case 4: table(4);
				...
				if(cekpeminjaman("Kamis",point->namar,"Malam")){
					g_peminjaman(point->namar,"Malam","Kamis");	
				}else{
					gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
					goto ulang;
				}
		...
		case 5: table(4);
				...
				if(cekpeminjaman("Jumat",point->namar,"Malam")){
					g_peminjaman(point->namar,"Malam","Jumat");	
				}else{
					gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
					goto ulang;
				}
		...
		case 6:table(4);
				...
				if(waktu=='1'){
					if(cekpeminjaman("Sabtu",point->namar,"Siang")){
						g_peminjaman(point->namar,"Siang","Sabtu");	
					}else{
						gotoxy(38,27);cout<<"                                                    "; 
						gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
						goto ulang;
					...
					if(cekpeminjaman("Sabtu",point->namar,"Malam")){
						g_peminjaman(point->namar,"Malam","Sabtu");	
					}else{
						gotoxy(38,27);cout<<"                                                    "; 
						gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
						goto ulang;
		...
		case 7:table(4);
				...
				if(waktu=='1'){
					if(cekpeminjaman("Minggu",point->namar,"Siang")){
						g_peminjaman(point->namar,"Siang","Minggu");	
					}else{
						gotoxy(38,27);cout<<"                                                    "; 
						gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
						goto ulang;
					...
					if(cekpeminjaman("Minggu",point->namar,"Malam")){
						g_peminjaman(point->namar,"Malam","Minggu");	
					}else{
						gotoxy(38,27);cout<<"                                                    "; 
						gotoxy(38,32); cout<<"Ruang Sudah Dipinjam Silahkan Pilih Kembali"; getch();
						goto ulang;
...
void opening(){
	for(int i=0;i<5;i++){
			system("COLOR 0A");gotoxy(0,8);cout<<sprf;Sleep(150);
			system("COLOR 0B");gotoxy(0,8);cout<<sprf;Sleep(150);
			system("COLOR 0C");gotoxy(0,8);cout<<sprf;Sleep(150);
			system("COLOR 0D");gotoxy(0,8);cout<<sprf;Sleep(150);
			system("COLOR 0E");gotoxy(0,8);cout<<sprf;Sleep(150);
		}
		gotoxy(52,32);cout<<"Press Enter";	
		Sleep(500);gotoxy(52,32);cout<<"           ";Sleep(500);gotoxy(52,32);cout<<"Press Enter";
		Sleep(500);gotoxy(52,32);cout<<"           ";Sleep(500);gotoxy(52,32);cout<<"Press Enter";getch();
		system("COLOR 0F");gotoxy(0,8);cout<<sprf;Sleep(150);
}
...
int g_pilihruang(int pildata, int y){
	if(y<32){
		if(pildata==1){
			y = 7;
			gotoxy(11,y);cout<<"[";gotoxy(46,y);cout<<"]";
